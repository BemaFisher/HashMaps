# Description: Hash Map implementation using Dynamic array and Singly Linked List.
...
class HashMap:
    ...
    def get(self, key: str) -> object:
        ...
        l_list = self.buckets[hash_index]
    ...
    def put(self, key: str, value: object) -> None:
        ...
        the hash map, its associated value must be replaced with the new value. If a given key is
    ...
    def resize_table(self, new_capacity: int) -> None:
        ...
        if new_capacity < 1:
            return
        # initialize new DA and append empty LL
        new_da = DynamicArray()
        for val in range(new_capacity):
            new_da.append(LinkedList())

        # placeholder for old capacity and data
        old_capacity = self.capacity
        old_buckets = self.buckets

        # point current hashmap to new da structure
        self.buckets = new_da
